      ...
      <div className="space-y-6">
         ...
         <div className="rounded-lg border border-gray-700 overflow-hidden bg-[#1b1b1b]">
            <iframe
               ...
               src="/Kenny_Chen_Resume.pdf#view=FitH"
               className="w-full h-[80vh]"
            />
         </div>

         <p className="text-gray-400 text-sm">
            If the embed does not load, <a className="underline" href="/Kenny_Chen_Resume.pdf" target="_blank" rel="noreferrer noopener">open the PDF in a new tab</a>.
         </p>
      </div>
   );
}
